...
import com.wisenable.dms.datasource.mappers.UserMapper;
import com.wisenable.dms.datasource.mappers.UserMapperEx;
...
import com.wisenable.dms.utils.ExceptionCodeConstants;
...
public class UserService {
    ...
    public void registerUser(UserEx ue, Integer manageRoleId, HttpServletRequest request) throws Exception {
        ...
        if (BusinessConstants.DEFAULT_MANAGER.equals(ue.getLoginName())) {
            ...
            shipperService.addAppId(ue.getId());
