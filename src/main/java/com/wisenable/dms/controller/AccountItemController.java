...
import com.wisenable.dms.datasource.vo.AccountItemVo4List;
...
public class AccountItemController {
    private final Logger logger = LoggerFactory.getLogger(AccountItemController.class);
            ...
            if (null != dataList) {
                for (AccountItemVo4List ai : dataList) {
                    ...
                    if(BusinessConstants.TYPE_MONEY_IN.equals(type)) {
                        ...
                        item.put("eachAmount", (eachAmount.compareTo(BigDecimal.ZERO)) < 0 ? BigDecimal.ZERO.subtract(eachAmount): eachAmount);
                    }
