...
public class GlobalExceptionHandler {
    ...
    public Object handleException(Exception e, HttpServletRequest request) {
        ...
        if (e instanceof BusinessParamCheckingException) {
            ...
            status.put(ExceptionConstants.GLOBAL_RETURNS_MESSAGE, e.getMessage());
            return status;
        }
    ...
    @ResponseBody
    public BaseResponseObject<Object> handleBusinessException(BusinessException e, HttpServletRequest request) {
        log.error("BusinessException Occured => url : {}", request.getRequestURL(), e);
        return BaseResponseObject.error(e.getCode(), e.getMsg());
    }
}