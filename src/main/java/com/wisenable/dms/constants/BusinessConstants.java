...
public class BusinessConstants {
    ...
    public static final String SUB_TYPE_PURCHASE_IN = "订货单";
    /**
     * 生产类型分类
     * 生产入库
     * */
    ...
    public static final String LOG_OPERATION_TYPE_ROLLBACK = "反审状态";
    ...
    public static final String SHIPPER_KEY = "dms:shipper:";
}
